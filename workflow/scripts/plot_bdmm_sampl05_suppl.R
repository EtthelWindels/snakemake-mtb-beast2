...
uninfperiod_Ma <- plot_latentperiod("Malawi", x_max=5, lineage_labels=c("L1","L2","L3","L4"), lineage_colours=c(L4_col,L3_col,L2_col,L1_col)) +
  theme(plot.margin = margin(b=0.5, l=0.5, unit="cm"))
uninfperiod_Ta <- plot_latentperiod("Tanzania", x_max=5, lineage_labels=c("L1","L2","L3","L4"), lineage_colours=c(L4_col,L3_col,L2_col,L1_col)) +
...
uninfperiod_TG <- plot_latentperiod("The Gambia", x_max=10, lineage_labels=c("L2","L4","L6"), lineage_colours=c(L6_col,L4_col,L2_col)) +
  theme(plot.margin = margin(b=0.5, unit="cm")) 
uninfperiod_VN <- plot_latentperiod("Vietnam", x_max=20, lineage_labels=c("L1","L2","L4"), lineage_colours=c(L4_col,L2_col,L1_col)) +
...
ggsave("bdmm_sampl05.png", plot=plot_all, path=dirname(snakemake@output[["png"]]), width=250, height=300, units="mm", bg='white')
ggsave("bdmm_sampl05.svg", plot=plot_all, path=dirname(snakemake@output[["svg"]]), width=250, height=300, units="mm", bg='white')